...
const APP_ID = "48919c63";
const APP_KEY = "be2d09870c2f7be4a626fdfd36e9784c";
...
const AppComponent = () => {
  ...
  return (
    <Container>
      <Header>
        <AppName>
          <RecipeImage src="/react-recipe-finder/logo2.svg" />
          Food Haven
        </AppName>
        <SearchBox>
      ...
      <RecipeListContainer>
        {recipeList?.length ? (
          ...
          <Placeholder src="/react-recipe-finder/logo2.svg" />
        )}
      </RecipeListContainer>
    </Container>
  );
